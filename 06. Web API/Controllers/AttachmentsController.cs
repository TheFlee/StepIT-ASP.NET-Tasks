...
namespace _06._Web_API.Controllers
{
    ...
    public class AttachmentsController : ControllerBase
    {
        ...
        public AttachmentsController(IAuthorizationService authorizationService, ITaskItemService taskItemService, IProjectService projectService, IAttachmentService attachmentService)
        {
            ...
            int taskId, IFormFile file, CancellationToken cancellationToken)
        {
            ...
            attachment = await _attachmentService.UploadAsync(
                taskId, stream, file.FileName, file.ContentType, file.Length, UserId!, cancellationToken);
        ...
        {
            var info = await _attachmentService.GetAttachmentInfoAsync(id);
            if (info is null)
                return NotFound();
        ...
        public async Task<IActionResult> Delete(int id, CancellationToken cancellationToken)
        {
            ...
            var authResult = await _authorizationService.AuthorizeAsync(User, project, "ProjectOwnerOrHigher");
            if (!authResult.Succeeded)
                return Forbid();
