...
namespace _06._Web_API.Migrations
{
    ...
    [Migration("20260220120046_AddProjectStatus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_06._Web_API.Models.TaskAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("_06._Web_API.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("_06._Web_API.Models.TaskAttachment", b =>
                {
                    b.HasOne("_06._Web_API.Models.TaskItem", "TaskItem")
                        .WithMany("Attachments")
                        .HasForeignKey("TaskItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_06._Web_API.Models.ApplicationUser", "UploadedUser")
                        .WithMany()
